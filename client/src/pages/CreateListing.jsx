    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form className='flex flex-col sm:flex-row gap-4'>
            <div className='flex flex-col gap-4 flex-1 gap-4'> 
                ...
                <input type="text" placeholder='Adress' className='border p-3 rounded-lg' id='adress' required/>
            ...
            <div className='flex flex-col flex-1 gap-4'>
                ...
                <span className='font-normal text-gray-600 ml-2'>The first image will will be the cover (max 6) </span></p>
