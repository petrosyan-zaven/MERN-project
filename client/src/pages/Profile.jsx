  ...
  return (
    <div className="p-3 max-w-lg mx-auto">
      ...
      <input onChange={(e) => setFile(e.target.files[0])} type="file" ref={fileRef} hidden accept='image/*'/>
        <img onClick={()=> fileRef.current.click()} src={formData.avatar || currentUser.avatar} className='rounded-full h-24 w-24 object-cover cursor-pointer my-7 self-center mt-2'/>
        ...
        <input type="text" placeholder="email" id="email" className="border p-3 rounded-lg"
          ...
          onChange={handleChange}
        />
        <input type="password" placeholder="paswword" id="paswword" className="border p-3 rounded-lg" />
